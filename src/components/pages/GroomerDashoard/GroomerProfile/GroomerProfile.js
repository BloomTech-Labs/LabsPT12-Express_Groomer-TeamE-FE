...
const GroomerProfile = props => {
  ...
  console.log(props.loggedInUserData, 'groomerDash');
      ...
      <section className="middle-content">
        ...
        <GroomerInfo className="information">
          <p>
            ...
            efficitur sapien a elit iaculis faucibus. Donec molestie, lacus et
            consequat luctus, odio mi sagittis lacus, vitae blandit nibh libero
            quis justo. Sed ac pellentesque augue, vitae vestibulum quam.
            Pellentesque at laoreet ligula. Nunc aliquet lacus urna, vitae
            eleifend risus venenatis sit amet. Donec pellentesque mollis tortor
            sed tincidunt. Vestibulum fermentum egestas quam, quis posuere nisl
            pretium ut. Praesent suscipit porttitor erat. Suspendiss
          </p>
...
export default connect(mapStateToProps, {})(GroomerProfile);
